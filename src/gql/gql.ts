 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query allEvents($where: EventFilter, $sort: [EventSorting!]) {\n  allEvent(where: $where, sort: $sort) {\n    _id\n    title\n    startDate\n    endDate\n    url\n    bgColor\n    mergedTitle\n    image {\n      asset {\n        _id\n        metadata {\n          lqip\n          blurHash\n        }\n        assetId\n      }\n    }\n    project {\n      title\n      bgColor\n      image {\n        asset {\n          _id\n          assetId\n          metadata {\n            lqip\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query allEvents($where: EventFilter, $sort: [EventSorting!]) {\n  allEvent(where: $where, sort: $sort) {\n    _id\n    title\n    startDate\n    endDate\n    url\n    bgColor\n    mergedTitle\n    image {\n      asset {\n        _id\n        metadata {\n          lqip\n          blurHash\n        }\n        assetId\n      }\n    }\n    project {\n      title\n      bgColor\n      image {\n        asset {\n          _id\n          assetId\n          metadata {\n            lqip\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
